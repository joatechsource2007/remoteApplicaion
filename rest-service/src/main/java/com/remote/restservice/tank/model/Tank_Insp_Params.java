...
public class Tank_Insp_Params {
    ...
    public Tank_Insp_Params() {

        {
            ...
            listOfFindSpParameters.add(SpParameter.builder().name("p_TANK_VOL").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_SW_CD").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_AREA_CD").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_TRANSM_YN").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_TANK_RCV").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_INSP_STATE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_INSP_SAWON").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfFindSpParameters.add(SpParameter.builder().name("p_INSP_EXP_T").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
        }

        {
            ...
            listOfFind2SpParameters.add(SpParameter.builder().name("p_TANK_CODE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
        }
