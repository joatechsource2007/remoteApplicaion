...
//        listOfAllSpParameters.add(SpParameter.builder().name("OPT").direction(SpParameter.Direction.IN).jdbcType(JDBCType.INTEGER).build());
        ...
        //검색
        {
            ...
            listOfQuerySpParameters.add(SpParameter.builder().name("p_HIGH_YN").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfQuerySpParameters.add(SpParameter.builder().name("p_ALL_YN").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
...
//            listOfQuerySpParameters.add(SpParameter.builder().name("pAppCert").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
        ...
        // 달력 정보
        {
            ...
            listOfFind2SpParameters.add(SpParameter.builder().name("p_TRANSM_CD").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            ...
            listOfFind2SpParameters.add(SpParameter.builder().name("p_OrderBY").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
        }
