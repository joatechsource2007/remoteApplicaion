...
//        listOfAllSpParameters.add(SpParameter.builder().name("OPT").direction(SpParameter.Direction.IN).jdbcType(JDBCType.INTEGER).build());
        ...
        // wsp_Get_Customer_FIND
        {
            ...
            listOfQuerySpParameters.add(SpParameter.builder().name("p_TRANSM_CD").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            ...
            listOfQuerySpParameters.add(SpParameter.builder().name("p_CUST_TYPE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfQuerySpParameters.add(SpParameter.builder().name("p_FIND_TEXT1").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfQuerySpParameters.add(SpParameter.builder().name("p_FIND_TEXT2").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfQuerySpParameters.add(SpParameter.builder().name("p_CU_BIZ_TYPE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfQuerySpParameters.add(SpParameter.builder().name("p_CU_CARE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfQuerySpParameters.add(SpParameter.builder().name("p_CU_CONS_TYPE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
...
//            listOfQuerySpParameters.add(SpParameter.builder().name("pAppCert").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
        ...
        //wsp_Get_Base_Code  기초 콤보 코드리스트
        {
            listOfInitSpParameters.add(SpParameter.builder().name("p_CodeType").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfInitSpParameters.add(SpParameter.builder().name("p_C_MNG_NO").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfInitSpParameters.add(SpParameter.builder().name("p_FIND_TEXT").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfInitSpParameters.add(SpParameter.builder().name("p_UserNo").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
            listOfInitSpParameters.add(SpParameter.builder().name("p_APP_CERT").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
        }

        // wsp_CUST_INFO   거래처 정보 SELECT
        {
            ...
            listOfFindSpParameters.add(SpParameter.builder().name("p_CUST_TYPE").direction(SpParameter.Direction.IN).jdbcType(JDBCType.VARCHAR).build());
